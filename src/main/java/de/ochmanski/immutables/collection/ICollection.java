...
public interface ICollection<E> extends Checked<@NotNull E>, Iterable<@NotNull E>
{
  ...
  @Contract(pure = true)
  void forEachOrdered(@NotNull final Consumer<? super @NotNull E> consumer, @NotNull final Comparator<? super @NotNull E> comparator);
  ...
  @UnmodifiableView
  @Contract(value = "_ -> new", pure = true)
  default Stream<@NotNull E> sortedStream(@NotNull final Comparator<? super @NotNull E> comparator)
  {
