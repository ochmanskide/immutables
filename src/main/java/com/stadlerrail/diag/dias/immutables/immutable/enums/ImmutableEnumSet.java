...
public class ImmutableEnumSet<E extends @NotNull Enum<@NotNull E>> implements ISet<@NotNull E>
{
  ...
  @Builder.Default
  ImmutableSet<@NotNull E> set = ImmutableSet.empty();
  ...
  {
    return (ImmutableEnumSet) EMPTY;
  }

  @NotNull
  @Unmodifiable
  @UnmodifiableView
  private static final ImmutableEnumSet<Equalable.@NotNull Dummy> EMPTY = createConstant();

  @NotNull
  @Unmodifiable
  @UnmodifiableView
  @Contract(value = "-> new", pure = true)
  private static ImmutableEnumSet<Equalable.@NotNull Dummy> createConstant()
  {
    return ImmutableEnumSet.<Equalable.@NotNull Dummy>builder().build();
  }
  //</editor-fold>
