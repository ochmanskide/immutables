package com.stadlerrail.diag.dias.immutables.immutable.enums;
...
import com.stadlerrail.diag.dias.immutables.equalable.Equalable.Dummy;
...
public class ImmutableEnumMap<K extends @NotNull Enum<@NotNull K>, V> implements IMap<@NotNull K, @NotNull V>
{
  ...
  {
    return (ImmutableEnumMap) EMPTY;
  }

  @NotNull
  @Unmodifiable
  @UnmodifiableView
  private static final ImmutableEnumMap<Equalable.@NotNull Dummy, Equalable.@NotNull Dummy> EMPTY = createConstant();

  @NotNull
  @Unmodifiable
  @UnmodifiableView
  @Contract(value = "-> new", pure = true)
  private static ImmutableEnumMap<Equalable.@NotNull Dummy, Equalable.@NotNull Dummy> createConstant()
  {
    return ImmutableEnumMap.<@NotNull Dummy, @NotNull Dummy>builder().build();
  }
  //</editor-fold>
  ...
  public static <K extends @NotNull Enum<@NotNull K>, V> ImmutableEnumMap<@NotNull K, @NotNull V> of(
    ...
    if (map.isEmpty()) {
      final Class<K> keyType = getComponentTypeFromConstructor(key);
      @SuppressWarnings(MISMATCHED_QUERY_AND_UPDATE_OF_COLLECTION)
  ...
  public ImmutableEnumSet<@NotNull K> keySet() {
    return ImmutableEnumSet.of(getMap().keySet());
  }
  ...
  public ImmutableList<@NotNull V> values() {
    return ImmutableList.of(getMap().values());
  }
  //</editor-fold>
