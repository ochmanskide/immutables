...
import com.stadlerrail.diag.dias.immutables.collection.Checked;
...
public interface IMap<K, V> extends Checked<@NotNull K>, Iterable<IMap.@NotNull Entry<@NotNull K, @NotNull V>>
{
  ...
  class Entry<K, V> implements Equalable<@NotNull Entry<@NotNull K, @NotNull V>>, Comparable<@NotNull Entry<@NotNull K, @NotNull V>>
  {
    ...
    private static <K, V> int orderAsc(@Nullable final Entry<@NotNull K, @NotNull V> a, @Nullable final Entry<@NotNull K, @NotNull V> b)
    {
      if (a == b) {
        return 0;
      }
  ...
  @Unmodifiable
  @Contract(pure = true)
  default IntFunction<@NotNull K @NotNull []> getKey()
  {
  ...
  @Unmodifiable
  @Contract(pure = true)
  default IntFunction<@NotNull V @NotNull []> getValue()
  {
  ...
  @Unmodifiable
  @Contract(value = " -> new", pure = true)
  default Class<@NotNull V> getComponentTypeFromValue() {
    return Checked.getComponentTypeFromConstructor(getValue());
  }
  ...
  @Override
  @Contract(pure = true)
  default void forEach(@NotNull final Consumer<? super @NotNull Entry<@NotNull K, @NotNull V>> consumer)
  {
    entrySet().forEach(consumer);
  }

  @Contract(pure = true)
  default void forEachOrdered(@NotNull final Consumer<? super IMap.@NotNull Entry<@NotNull K, @NotNull V>> consumer)
  {
  ...
  @Override
  @Contract(pure = true)
  default Iterator<@NotNull Entry<@NotNull K, @NotNull V>> iterator() {
