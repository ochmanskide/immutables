...
public interface EList<E extends @NotNull Comparable<@NotNull E> & @NotNull Equalable<@NotNull E>> extends EqualableCollection<@NotNull E>, IList<@NotNull E>
{
  /**
  ...
  @UnmodifiableView
  @Contract(value = "_ -> new", pure = true)
  default EList<@NotNull E> add(@NotNull final E c)
  {
    return addAll(c);
  }
  ...
  @UnmodifiableView
  @Contract(value = "_ -> new", pure = true)
  default EList<@NotNull E> addAll(@NotNull final E c)
  {
  ...
  @UnmodifiableView
  @Contract(value = "_ -> new", pure = true)
  default EList<@NotNull E> addAll(@NotNull final EqualableCollection<? extends @NotNull E> c)
  {
  ...
  @UnmodifiableView
  @Contract(value = "_ -> new", pure = true)
  default EList<@NotNull E> addAll(@NotNull final Collection<? extends @NotNull E> c)
  {
    return addAll(c.stream());
  }
  ...
  @UnmodifiableView
  @Contract(value = "_ -> new", pure = true)
  default EList<@NotNull E> addAll(@NotNull final Stream<? extends @NotNull E> c)
  {
  ...
  @Override
  @Contract(pure = true)
  default IntFunction<@NotNull E @NotNull []> getKey()
  {
    return getCollection().getKey();
  }

  int compareTo(@NotNull final EList<@NotNull E> o);

  int compareTo(@NotNull final EqualableList<@NotNull E> o);
}
