...
public class FluentEnumMap<K extends @NotNull Enum<@NotNull K> & @NotNull Fluent<? extends @NotNull K>, V extends @NotNull Equalable<? extends @NotNull V>>
  ...
  private static FluentEnumMap<? extends @NotNull Fluent<?>, ? extends @NotNull Fluent<?>> createConstant() {
    return FluentEnumMap.<@NotNull Dummy, @NotNull Fluent<?>>builder().build();
  }
  //</editor-fold>
