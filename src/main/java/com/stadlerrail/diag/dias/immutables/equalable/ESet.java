...
public interface ESet<E extends @NotNull Comparable<@NotNull E> & @NotNull Equalable<@NotNull E>> extends EqualableCollection<@NotNull E>, ISet<@NotNull E>
{
  ...
  @UnmodifiableView
  @Contract(value = "_ -> new", pure = true)
  default ESet<@NotNull E> add(@NotNull final E c)
  {
    return addAll(c);
  }
  ...
  @UnmodifiableView
  @Contract(value = "_ -> new", pure = true)
  default ESet<@NotNull E> addAll(@NotNull final E c)
  {
  ...
  @UnmodifiableView
  @Contract(value = "_ -> new", pure = true)
  default ESet<@NotNull E> addAll(@NotNull final EqualableCollection<? extends @NotNull E> c)
  {
  ...
  @UnmodifiableView
  @Contract(value = "_ -> new", pure = true)
  default ESet<@NotNull E> addAll(@NotNull final Collection<? extends @NotNull E> c)
  {
    return addAll(c.stream());
  }
  ...
  @UnmodifiableView
  @Contract(value = "_ -> new", pure = true)
  default ESet<@NotNull E> addAll(@NotNull final Stream<? extends @NotNull E> c)
  {
  ...
  int compareTo(@NotNull final ESet<@NotNull E> o);

  int compareTo(@NotNull EqualableSet<@NotNull E> o);
}
